    ...
    return AppDynamicReportTable<ProductStockMovementRow>(
      ...
      columns: [
        ...
        ReportColumnSpec<ProductStockMovementRow>(
          ...
          isNumeric: true,
          alignment: Alignment.center,
          getValue: (row) => row.inTotalQty.toStringAsFixed(0),
        ),
        ReportColumnSpec<ProductStockMovementRow>(
          id: 'inCost',
          label: 'ت. العبوة',
          ...
          getValue: (row) => row.inCost > 0 ? row.unitCost.toStringAsFixed(0) : '0',
        ),
        ...
        ReportColumnSpec<ProductStockMovementRow>(
          ...
          isNumeric: true,
          alignment: Alignment.center,
          getValue: (row) => row.outTotalQty.toStringAsFixed(0),
        ),
        ReportColumnSpec<ProductStockMovementRow>(
          id: 'outCost',
          label: 'ت. العبوة',
          ...
          isNumeric: true,
          alignment: Alignment.centerRight,
          getValue: (row) => row.outCost > 0 ? row.unitCost.toStringAsFixed(0) : '0',
        ),

        // رصيد نهاية المدة (Ending Balance)
        ReportColumnSpec<ProductStockMovementRow>(
          id: 'balCartons',
          label: 'كرتون',
          flex: 12,
          isNumeric: true,
          alignment: Alignment.center,
          getValue: (row) => '${row.balanceCartons}',
        ),
        ReportColumnSpec<ProductStockMovementRow>(
          id: 'balPieces',
          label: 'حبة',
          ...
          isNumeric: true,
          alignment: Alignment.center,
          getValue: (row) => row.balancePieces.toStringAsFixed(0),
        ),
        ReportColumnSpec<ProductStockMovementRow>(
          id: 'balTotalQty',
          label: 'إجمالي الرصيد',
        ...
        ReportColumnSpec<ProductStockMovementRow>(
          ...
          isNumeric: true,
          alignment: Alignment.centerRight,
          getValue: (row) => row.unitCost.toStringAsFixed(0),
        ),
      ],
      items: payload.rows,
      footerSummaries: [
